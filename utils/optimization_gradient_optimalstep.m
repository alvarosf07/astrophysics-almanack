%*******************************************************************************
%This Matlab function "grad_optim_step" implements the gradient descent method
...
while(status==0)
    ...
    d_k      = - grad_f(x_k);
    alpha_min = @(alpha) obj_f(old_x_k+alpha_0*d_k);
    alpha_k = fminsearch(alpha_min, alpha_0);
